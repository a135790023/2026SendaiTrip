    ...
    <div className="relative h-screen w-full overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 flex flex-col h-full pt-safe-top pb-24 px-6 justify-between animate-fade-in">
        ...
        <div className="w-full">
          ...
          <Link 
            href="/itinerary"
            className="group relative block overflow-hidden rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl shadow-2xl transition-all active:scale-[0.98]"
          >
